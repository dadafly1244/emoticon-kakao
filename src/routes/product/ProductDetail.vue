    ...
    <Modal v-if="showModal" @close-modal=";(showModal = false), (isButtonDisable = true)">
      <div class="modal-inner">
        ...
        <div class="modal-body">
          <div class="modal-body--card head">
            <div class="detail">
              ...
              <div class="detail--price">
                <div class="price--no-discount">
                  {{ addComma(productStore.product.price * 1.2) }}원
                </div>
              </div>
            </div>
            <div class="thumbnail">
          ...
          <dl class="list_guide" :class="{ guide_close: iscloseDd }">
            <dt>
              <button @click="iscloseDd = !iscloseDd" class="btn_open">
                <h4>상품안내</h4>
                <span :class="{ ico_open: !iscloseDd }" class="material-symbols-rounded"
                  >expand_more</span
                >
                <span :class="{ ico_open: iscloseDd }" class="material-symbols-rounded"
                  >expand_less</span
            ...
            <dd>
              선물 이모티콘은 결제 완료 후 선물받는 친구에게 이모티콘 메세지가 발송되므로 수신자가
              직접 이모티콘을 다운로드 받을 수 있습니다.
            </dd>
            <dd>
              구매한 이모티콘은 카카오톡 모바일 앱 및 카카오톡 PC 서비스에서 사용할 수 있습니다.
            </dd>
            <dd>
              이 이모티콘을 구매, 또는 선물하면 카카오의 다른 서비스에서도 사용할 수 있습니다. 다만,
              플러스 다운로드 하는 경우 카카오톡에서만 사용 가능합니다. 카카오는 회사의 사정, 기타
              제반 여건에 따라 이모티콘 사용처를 추가하거나 변경할 수 있습니다.
            </dd>
            <dd>
              카카오 이모티콘샵에서는 카카오톡 모바일 앱 내 이모티콘 스토어에서 판매하고 있는
              이모티콘 중 일부는 판매하지 않을 수 있습니다.
            </dd>
            <dd>
              대한민국 카카오톡 사용자가 아닌 경우에는 일부 기능 또는 구매가 제한될 수 있습니다.
            </dd>
            <dd>
              미성년자인 회원이 법정대리인의 동의없이 상품 등을 구매하는 경우 본인 또는 법정대리인이
              이를 취소할 수 있습니다.
            </dd>
          </dl>
          <dl class="list_guide" :class="{ guide_close: iscloseDd2 }">
            <dt>
              <button @click="iscloseDd2 = !iscloseDd2" class="btn_open">
                <h4>해지 및 환불 안내</h4>
                <span :class="{ ico_open: !iscloseDd2 }" class="material-symbols-rounded"
                  >expand_more</span
                >
                <span :class="{ ico_open: iscloseDd2 }" class="material-symbols-rounded"
                  >expand_less</span
            ...
            <dd>
              결제 후 계약내용에 관한 서면을 교부받은 날(이하 ‘구매일’)로부터 7일 이내에 청약철회할
              수 있습니다. 단, 콘텐츠의 내용이 표시·광고 내용과 다르거나 계약 내용과 다르게 이행된
              경우에는 당해 콘텐츠를 공급받은 날로부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던
              날로부터 30일 이내에 청약철회할 수 있습니다.
            </dd>
            <dd>
              아래 내용에 해당하는 경우에는 청약철회 또는 환불 신청이 제한될 수 있습니다.
              <ol class="list_subguide">
                <li>
                  1) 구매일로부터 7일 이내에 용역 또는&nbsp;「문화산업진흥 기본법」 제2조제5호의
                  디지털콘텐츠의 제공이 개시된 경우. 다만, 가분적 용역 또는 가분적 디지털콘텐츠로
                  구성된 계약의 경우에는 제공이 개시되지 아니한 부분에 대하여는 예외로 함.
                </li>
            ...
            <dd>
              ...
              에서 신청 할 수 있으며, 소비자의 청약철회일로부터 3 영업일 이내에 지급받은 대금의
              환급을 정당한 사유 없이 지연하는 경우 소비자는 지연기간에 대해서 연 20%의 지연
              배상금을 회사에게 청구할 수 있습니다.
            </dd>
            <dd>
              선물한 이모티콘의 경우 구매일로부터 7일이 경과하였거나, 선물을 받은 이용자가 다운로드
              받은 경우 환불이 불가합니다.
            </dd>
            <dd>청약철회 및 환불 시 이미 사용하신 할인쿠폰은 재발급해드리지 않습니다.</dd>
            <dd>
              그 외 다른 사항에 대한 청약철회 및 환불은 카카오 유료서비스 이용약관 및
              콘텐츠산업진흥법의 기준에 따르며, 피해보상 및 불만 처리 등 필요한 사항은
              <a
                href="https://cs.kakao.com/requests?category=278&amp;locale=ko&amp;node=30555&amp;service=94"
                class="link_txt"
                target="_blank"
