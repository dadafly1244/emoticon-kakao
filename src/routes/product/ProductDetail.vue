...
<div class="wrap">
  ...
  <div class="product--information">
      <div class="product--information--inner">
          ...
          <dl class="list_guide guide_close">
            <dt><button class="btn_open">
                <h4>상품안내</h4><span class="ico_comm ico_open"></span>
              </button></dt>
          ...
          <dl class="list_guide guide_close">
            <dt><button class="btn_open">
                <h4>해지 및 환불 안내</h4><span class="ico_comm ico_open"></span>
              </button></dt>
            ...
            <dd>청약 철회/환불 요청을 원하실 경우 
              <a href="https://cs.kakao.com/requests?category=278&amp;locale=ko&amp;node=30555&amp;service=94"
                class="link_txt" target="_blank" rel="noreferrer">[카카오 고객센터]</a> 에서 신청 할 수 있으며, 소비자의 청약철회일로부터 3 영업일
